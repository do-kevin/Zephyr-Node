            ...
            <div className="card animated zoomIn">
              <div className="card-body feature-cards">
                ...
                <p className="card-text text-left">
                  ...
                  tincidunt magna et volutpat fringilla. Integer pretium cursus
                  dignissim. Fusce lectus est, vestibulum ut metus et,
          ...
          <div className="col">
            <div className="card animated slideInRight">
              <div className="card-body feature-cards">
                ...
                <p className="card-text text-left">
                  Morbi accumsan sapien vitae sodales porta. Nulla non nibh eget
                  urna dictum hendrerit. Vivamus mattis velit sed lacus sodales,
                  vel facilisis lectus auctor. Donec porttitor pulvinar libero,
                  et mollis eros congue quis. Vestibulum risus ex, mattis et
                  aliquet quis, viverra eu sem. Curabitur varius tempor mi at
                  egestas.
                </p>
              </div>
            </div>
            ...
            <div className="card animated slideInLeft">
              <div className="card-body feature-cards">
                ...
                <p className="card-text text-left">
                  ...
                  vestibulum tortor, ut efficitur magna elementum eu. Nam lectus
                  eros, elementum at nulla id, ullamcorper feugiat neque. Nullam
                  eget sem porttitor nulla viverra cursus.
                </p>
              </div>
            </div>
            <br />
            ...
            <div className="card animated slideInUp">
              <div className="card-body feature-cards">
                ...
                <p className="card-text text-left">
                  ...
                  Suspendisse massa ante, venenatis nec luctus at, vestibulum in
                  felis. Nulla ante diam, pellentesque a nunc nec, varius
                  pharetra nunc. Class aptent taciti sociosqu ad litora torquent
                  per conubia nostra, per inceptos himenaeos. Suspendisse
                  sollicitudin a orci ac mollis. Curabitur vehicula tristique
                  porttitor.
                </p>
              </div>
            </div>
            ...
            <div className="card animated slideInRight">
              <div className="card-body feature-cards">
                ...
                <p className="card-text text-left">
                  ...
                  volutpat tempor lacus quis, placerat interdum tortor. Aliquam
                  in dolor vel nunc hendrerit auctor. Maecenas non ante
                  consectetur, consequat nisi et, euismod risus. Nam id commodo
                  lorem. Cras volutpat nisl sit amet sem laoreet posuere.
                </p>
              </div>
            </div>
            <br />
